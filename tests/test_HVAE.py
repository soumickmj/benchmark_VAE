...
class Test_HVAE_Training:
    ...
    def hvae(self, model_configs, custom_encoder, custom_decoder, request):
        ...
        if alpha < 0.25:
            ...
            return HVAE(model_configs, encoder=custom_encoder)

        elif 0.5 <= alpha < 0.75:
            return HVAE(model_configs, decoder=custom_decoder)

        else:
            return HVAE(model_configs, encoder=custom_encoder, decoder=custom_decoder)
