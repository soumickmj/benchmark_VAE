...
class Test_VAMP_Training:
    ...
    def vamp(self, model_configs, custom_encoder, custom_decoder, request):
        ...
        if alpha < 0.25:
            ...
            return VAMP(model_configs, encoder=custom_encoder)

        elif 0.5 <= alpha < 0.75:
            return VAMP(model_configs, decoder=custom_decoder)

        else:
            return VAMP(model_configs, encoder=custom_encoder, decoder=custom_decoder)
