...
class Test_SVAE_Training:
    ...
    def svae(self, model_configs, custom_encoder, custom_decoder, request):
        ...
        if alpha < 0.25:
            ...
            return SVAE(model_configs, encoder=custom_encoder)

        elif 0.5 <= alpha < 0.75:
            return SVAE(model_configs, decoder=custom_decoder)

        else:
            return SVAE(model_configs, encoder=custom_encoder, decoder=custom_decoder)
