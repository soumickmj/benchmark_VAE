...
class Test_VAE_Training:
    ...
    def vae(self, model_configs, custom_encoder, custom_decoder, request):
        ...
        if alpha < 0.25:
            ...
            return VAE(model_configs, encoder=custom_encoder)

        elif 0.5 <= alpha < 0.75:
            return VAE(model_configs, decoder=custom_decoder)

        else:
            return VAE(model_configs, encoder=custom_encoder, decoder=custom_decoder)
