...
class Test_MIWAE_Training:
    ...
    def miwae(self, model_configs, custom_encoder, custom_decoder, request):
        ...
        if alpha < 0.25:
            ...
            return MIWAE(model_configs, encoder=custom_encoder)

        elif 0.5 <= alpha < 0.75:
            return MIWAE(model_configs, decoder=custom_decoder)

        else:
            return MIWAE(model_configs, encoder=custom_encoder, decoder=custom_decoder)
